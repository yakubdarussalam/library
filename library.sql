...
INSERT INTO `return_book` (`return_id`, `member_id`) VALUES
(5004, 2003),
(5005, 2004);
...
--
-- Table structure for table `return_book_detail`
--

CREATE TABLE `return_book_detail` (
...
--
-- Dumping data for table `return_book_detail`
--

INSERT INTO `return_book_detail` (`return_detail_id`, `return_id`, `book_id`, `return_date`, `penalty`, `description`) VALUES
(5510, 5004, 'B004', '2024-01-11', 30000, 'Late');
...
('ST04', 'Yakub Darussalam', 'yakub', '[][]', 'Male', 'staff', 'Yes');
...
--
-- Indexes for table `return_book_detail`
--
ALTER TABLE `return_book_detail`
...
--
ALTER TABLE `return_book`
  MODIFY `return_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5006;

--
-- AUTO_INCREMENT for table `return_book_detail`
--
ALTER TABLE `return_book_detail`
  MODIFY `return_detail_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5511;

--
-- AUTO_INCREMENT for table `taker`
--
ALTER TABLE `taker`
  MODIFY `taker_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4013;
