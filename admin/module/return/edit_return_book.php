    ...
    <section class="content">
        <div class="container-fluid ">
            ...
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <?php
                $sql = "SELECT * FROM return_book_detail WHERE  return_id = '$Return'";
                $ress = mysqli_query($conn, $sql);
                $data = mysqli_fetch_array($ress);
                ?>
                <!-- form start -->
                <form action="module/return/edit_return_book_action.php" method="POST">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" name="book_id" maxlength="50" value="<?php echo $data['book_id'];?>" required>
                        </div>
                        <div class="form-group">
                                <label for="">Return Date</label>
                                <input type="date" class="form-control" id="exampleInputEmail1" name="return_date" value="<?php echo $data['return_date'];?>" required>
                            </div>
                        <div class="form-group">
                            <label for="">Penalty</label>
                            <input type="number" class="form-control" id="exampleInputEmail1" name="penalty" maxlength="50" placeholder="Enter Penalty" value="<?php echo $data['penalty'];?>">
                        </div>
                        <div class="form-group">
                            <label for="">Description</label>
                            <input type="text" class="form-control" id="exampleInputEmail1" name="description" maxlength="50" placeholder="Enter Description" value="<?php echo $data['description'];?>" required>
                        </div>
                    </div>
                    <!-- /.card-body -->
